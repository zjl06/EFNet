...
###################################################################
# ########### Multiscale Semantic Detail Fusion Module #####################
###################################################################
...
###################################################################
# ########## Multiscale Edge-Enhanced Module ###############
###################################################################
class MEE(nn.Module):
...
class EFNet(nn.Module):
    ...
    def forward(self, x):
        ...
        x1a = self.MEE1(cr1, edge_att)
        x2a = self.MEE2(cr2, edge_att)
        x3a = self.MEE3(cr3, edge_att)
        x4a = self.MEE4(cr4, edge_att)
        inputs = [x1a, x2a, x3a, x4a]
        output = self.MSDF(inputs)
        cr2 = output + cr2
